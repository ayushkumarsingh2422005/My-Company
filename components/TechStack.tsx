...
const TechCard = ({ name, icon, level }: { name: string; icon: string; level: number }) => (
  <motion.div
    whileHover={{ y: -5 }}
    className="bg-gradient-to-br from-purple-900/30 to-transparent p-4 rounded-xl backdrop-blur-sm border border-purple-500/20"
  >
          ...
          {technologies.map((category, categoryIndex) => (
            ...
            >
              <h3 className="text-2xl font-semibold mb-6 text-center md:text-left">
                <span className="text-purple-500">/</span> {category.category}
              </h3>
